...
export const UI_CATALOG: Record<CoreLocale, Record<string, string>> = {
  "de": {
    ...
    "ppa_policy_submit_section": "Besucher legen an: {entity}",
    "ppa_policy_list_section": "Besucher sehen: {entity}",
    "ppa_col_field": "Feld",
    ...
    "ppa_fixed_hint": "Ein fester Wert wird automatisch eingetragen. Der Besucher sieht das Feld dann nicht.",
    ...
    "ppa_more": "Mehr",
    "ppa_less": "Weniger",
    "ppa_s_pick": "Besucher wählt hier einen bestehenden Eintrag aus",
    "ppa_s_fixed": "Wird automatisch auf „{value}“ gesetzt, Besucher sieht das Feld nicht",
    "ppa_s_never": "Die Seite fragt dieses Feld nicht ab",
    "ppa_s_hidden": "Besucher sieht das Feld nicht",
    "ppa_s_visitor_enters": "Besucher gibt ein",
  ...
  "en": {
    ...
    "ppa_policy_submit_section": "Visitors create: {entity}",
    "ppa_policy_list_section": "Visitors see: {entity}",
    "ppa_col_field": "Field",
    ...
    "ppa_fixed_hint": "A fixed value is filled in automatically. The visitor does not see the field.",
    ...
    "ppa_more": "More",
    "ppa_less": "Less",
    "ppa_s_pick": "Visitor picks an existing entry here",
    "ppa_s_fixed": "Set automatically to \"{value}\", visitor does not see the field",
    "ppa_s_never": "The page does not ask for this field",
    "ppa_s_hidden": "Visitor does not see the field",
    "ppa_s_visitor_enters": "Visitor enters",
...
export const LABELS: Record<CoreLocale, LabelBundle> = {
  "de": {
    "appgroup": "Werkstatt Auto Brandl",
    "apps": {
      "kunden": {
        "name": "Kunden",
        "app_id": "6aa94da65297da904085d71c",
        "fields": {
          "vorname": "Vorname",
          "nachname": "Nachname",
          "kundentyp": "Kundentyp",
      ...
      "mitarbeiter": {
        "name": "Mitarbeiter",
        "app_id": "6aa94dad44457dfc3ca4921c",
        "fields": {
          "email": "E-Mail",
          "vorname": "Vorname",
          "nachname": "Nachname",
      ...
      "teilebestand": {
        ...
        "fields": {
          ...
          "bestand": "Bestand (Stück)",
          "mindestbestand": "Mindestbestand (Stück)",
      ...
      "fahrzeuge": {
        "name": "Fahrzeuge",
        "app_id": "6aa94daf5902b993cd4338de",
        "fields": {
      ...
      "auftraege": {
        "name": "Aufträge",
        "app_id": "6aa94daf32649f17d9cf9867",
        "fields": {
          "auftragsnummer": "Auftragsnummer",
          "fahrzeug": "Fahrzeug",
          "annahmedatum": "Annahmedatum",
          "fertigstellungstermin": "Zugesagter Fertigstellungstermin",
          "kundenwunsch": "Kundenwunsch",
          "status": "Status",
          "mechaniker": "Zuständiger Mechaniker",
          "kilometerstand_annahme": "Kilometerstand bei Annahme (km)",
          "notizen": "Notizen"
        },
        "lookups": {
          "status": {
      ...
      "auftragspositionen": {
        ...
        "app_id": "6aa94db0a3a322a817b5d5a2",
        "fields": {
          "auftrag": "Auftrag",
      ...
      "rechnungen": {
        "name": "Rechnungen",
        "app_id": "6aa94db0b8f915fad738ff80",
        "fields": {
    ...
    "apps": {
      ...
      "auftraege": {
        ...
        "fields": {
          ...
          "fahrzeug": "Vehicle",
          "annahmedatum": "Intake Date",
          "fertigstellungstermin": "Promised Completion Date",
          "kundenwunsch": "Customer Request",
          "status": "Status",
          "mechaniker": "Assigned Mechanic",
          "kilometerstand_annahme": "Mileage at Intake (km)",
          "notizen": "Notes"
        },
        "lookups": {
          "status": {
      ...
      "auftragspositionen": {
        ...
        "fields": {
          "auftrag": "Work Order",
          "positionstyp": "Line Item Type",
          "bezeichnung": "Description",
          "menge": "Quantity",
          "einzelpreis": "Unit Price (€)",
          "mechaniker": "Mechanic",
          "dauer_stunden": "Duration (Hours)",
          "teil": "Part Used"
        },
        "lookups": {
          "positionstyp": {
