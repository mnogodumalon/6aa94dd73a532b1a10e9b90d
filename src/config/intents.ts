...
// <custom:intent-imports>
import { IconClipboardPlus, IconCircleDot, IconReceiptEuro } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neuer-auftrag', label: { de: 'Neuer Auftrag', en: 'New order' }, icon: IconClipboardPlus, description: 'Fahrzeug auswählen und Auftrag in 4 Schritten anlegen' },
  { path: '/intents/position-hinzufuegen', label: { de: 'Position buchen', en: 'Add position' }, icon: IconCircleDot, description: 'Arbeitszeit oder Ersatzteil zu einem offenen Auftrag buchen' },
  { path: '/intents/auftrag-abrechnen', label: { de: 'Auftrag abrechnen', en: 'Invoice order' }, icon: IconReceiptEuro, description: 'Fertigen Auftrag abrechnen und Rechnung anlegen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-15T13:53:49+00:00';
