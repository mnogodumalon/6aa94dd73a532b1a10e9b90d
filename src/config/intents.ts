...
// <custom:intent-imports>
import { IconClipboardPlus, IconListCheck, IconFileInvoice } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/auftrag-anlegen', label: { de: 'Auftrag anlegen', en: 'Create order' }, icon: IconClipboardPlus, description: 'Annahme legt einen neuen Auftrag für ein Fahrzeug an und weist einen Mechaniker zu.' },
  { path: '/intents/position-erfassen', label: { de: 'Position erfassen', en: 'Add order position' }, icon: IconListCheck, description: 'Mechaniker fügt einem Auftrag eine Arbeitsleistung oder ein verbautes Teil hinzu.' },
  { path: '/intents/rechnung-erstellen', label: { de: 'Rechnung erstellen', en: 'Create invoice' }, icon: IconFileInvoice, description: 'Annahme erstellt eine Rechnung zu einem fertigen Auftrag; Kunde wird automatisch übernommen.' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-21T13:22:44+00:00';
