...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/auftrag-anlegen', label: { de: 'Auftrag anlegen', en: 'Create Order' }, icon: IconClipboardPlus, description: 'Büromitarbeiter legt einen neuen Auftrag in 3 Schritten an.' },
  { path: '/intents/position-hinzufuegen', label: { de: 'Position hinzufügen', en: 'Add Position' }, icon: IconListCheck, description: 'Mechaniker oder Büro fügt einem Auftrag eine Arbeits- oder Teilposition hinzu.' },
  { path: '/intents/rechnung-erstellen', label: { de: 'Rechnung erstellen', en: 'Create Invoice' }, icon: IconFileInvoice, description: 'Büro erstellt eine Rechnung zu einem fertigen Auftrag und setzt den Status auf abgerechnet.' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-21T13:43:16+00:00';
