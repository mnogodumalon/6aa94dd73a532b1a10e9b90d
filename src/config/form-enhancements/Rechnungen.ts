...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['rechnungsnummer', 'auftrag', 'kunde', 'rechnungsdatum', 'faelligkeit', 'nettobetrag', 'mwst', 'bruttobetrag', 'status', 'zahlungseingang'],
  defaults: {
    'rechnungsdatum': { kind: 'today', withTime: false },
    'faelligkeit': { kind: 'todayOffset', days: 14, withTime: false },
    'status': { kind: 'lookup', key: 'offen', label: 'Offen' },
  },
  computed: {
    'mwst': { op: 'mul', left: { kind: 'field', key: 'nettobetrag' }, right: { kind: 'literal', value: 0.19 } },
    'bruttobetrag': { op: 'mul', left: { kind: 'field', key: 'nettobetrag' }, right: { kind: 'literal', value: 1.19 } },
  },
};
