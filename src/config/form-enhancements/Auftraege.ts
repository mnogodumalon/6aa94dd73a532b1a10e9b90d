...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['auftragsnummer', 'fahrzeug', { row: ['annahmedatum', 'fertigstellungstermin'] }, 'status', 'mechaniker', 'kilometerstand_annahme', 'kundenwunsch', 'notizen'],
  defaults: {
    'annahmedatum': { kind: 'today' },
    'fertigstellungstermin': { kind: 'todayOffset', days: 3 },
