...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["auftragsnummer", "fahrzeug", "status", {"row": ["annahmedatum", "fertigstellungstermin"]}, "mechaniker", "kilometerstand_annahme", "kundenwunsch", "notizen"],
  defaults: {
    'annahmedatum': { kind: 'today' },
    'status': { kind: 'lookup', key: 'angenommen', label: 'Angenommen' },
  },
  computed: {
    '_auftrags_dauer_tage': { kind: 'dateDiff', from: 'annahmedatum', to: 'fertigstellungstermin', unit: 'days' },
  },
};
