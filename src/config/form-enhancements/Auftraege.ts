...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['auftragsnummer', 'fahrzeug', 'annahmedatum', 'fertigstellungstermin', 'status', 'mechaniker', 'kilometerstand_annahme', 'kundenwunsch', 'notizen'],
  defaults: {
    'annahmedatum': { kind: 'today', withTime: false },
    'fertigstellungstermin': { kind: 'todayOffset', days: 3, withTime: false },
