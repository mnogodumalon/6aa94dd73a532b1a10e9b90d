// Auto-generated. Per-entity form-enhancements config for "Fahrzeuge".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['kennzeichen', 'marke', 'modell', 'halter', 'erstzulassung', 'kilometerstand', 'fahrgestellnummer', 'hu_faellig'],
  defaults: {
    'hu_faellig': { kind: 'todayOffset', days: 365, withTime: false },
  },
  computed: {},
};
