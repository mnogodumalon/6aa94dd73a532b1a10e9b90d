// Auto-generated. Per-entity form-enhancements config for "Teilebestand".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["artikelnummer", "bezeichnung", "hersteller", "einkaufspreis", "verkaufspreis", "bestand", "mindestbestand", "lagerplatz"],
  defaults: {
    'bestand': { kind: 'literal', value: 0 },
    'mindestbestand': { kind: 'literal', value: 5 },
  },
  computed: {
    '_gewinn_pro_stück': { op: 'sub', left: { kind: 'field', key: 'verkaufspreis' }, right: { kind: 'field', key: 'einkaufspreis' } },
  },
};
