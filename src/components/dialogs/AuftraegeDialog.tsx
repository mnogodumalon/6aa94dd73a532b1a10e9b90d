  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'fahrzeug': (
      <div key="fahrzeug" className="space-y-1.5">
        ...
        <Combobox
          id="fahrzeug"
          placeholder="Welches Auto wird bearbeitet?"
    ...
    'annahmedatum': (
      <div key="annahmedatum" className="space-y-1.5">
        ...
        <DatePicker
          id="annahmedatum"
          placeholder="Wann kommt das Auto an?"
          mode="date"
    ...
    'kundenwunsch': (
      <div key="kundenwunsch" className="space-y-1.5">
        ...
        <Textarea
          id="kundenwunsch"
          placeholder="Was soll repariert/gewartet werden?"
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Spezielle Hinweise, Besonderheiten..."
