  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'annahmedatum': (
      <div key="annahmedatum" className="space-y-1.5">
        ...
        <DatePicker
          id="annahmedatum"
          placeholder="Wann wird das Fahrzeug angenommen?"
          mode="date"
    ...
    'fertigstellungstermin': (
      <div key="fertigstellungstermin" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Termin für Fertigstellung?"
          mode="date"
    ...
    'kundenwunsch': (
      <div key="kundenwunsch" className="space-y-1.5">
        ...
        <Textarea
          id="kundenwunsch"
          placeholder="Was wünscht sich der Kunde? Mängel, Reparaturen, Inspektion..."
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Interne Anmerkungen, Besonderheiten, Ersatzteile-Notizen..."
