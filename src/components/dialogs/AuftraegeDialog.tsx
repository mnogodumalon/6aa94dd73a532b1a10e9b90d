  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'fahrzeug': (
      <div key="fahrzeug" className="space-y-1.5">
        ...
        <Combobox
          id="fahrzeug"
          placeholder="Welches Fahrzeug wird repariert?"
    ...
    'annahmedatum': (
      <div key="annahmedatum" className="space-y-1.5">
        ...
        <DatePicker
          id="annahmedatum"
          placeholder="Wann nimmt die Werkstatt an?"
          mode="date"
    ...
    'kundenwunsch': (
      <div key="kundenwunsch" className="space-y-1.5">
        ...
        <Textarea
          id="kundenwunsch"
          placeholder="Was wünscht der Kunde? Fehler, Inspektionen, Revisionen..."
    ...
    'mechaniker': (
      <div key="mechaniker" className="space-y-1.5">
        ...
        <Combobox
          id="mechaniker"
          placeholder="Wer ist der zuständige Mechaniker?"
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Zusätzliche Anmerkungen, Besonderheiten..."
