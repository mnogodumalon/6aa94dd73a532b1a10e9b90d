...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  ...
  mitarbeiter: { vorname: "Bitte den Vornamen eingeben.", nachname: "Bitte den Nachnamen eingeben.", rolle: "Bitte die Rolle auswählen.", status: "Bitte den Status auswählen." },
  teilebestand: { artikelnummer: "Bitte die Artikelnummer eingeben.", bezeichnung: "Bitte die Bezeichnung eingeben." },
  fahrzeuge: { kennzeichen: "Bitte das Kennzeichen eingeben.", marke: "Bitte die Marke eingeben.", modell: "Bitte das Modell eingeben.", halter: "Bitte den Kunden auswählen." },
  auftraege: { auftragsnummer: "Bitte die Auftragsnummer eingeben.", fahrzeug: "Bitte das Fahrzeug auswählen.", annahmedatum: "Bitte das Annahmedatum wählen.", status: "Bitte den Status wählen." },
  auftragspositionen: { auftrag: "Bitte den Auftrag auswählen.", positionstyp: "Bitte Arbeit oder Teil wählen.", bezeichnung: "Bitte die Bezeichnung eingeben.", menge: "Bitte die Menge eingeben.", einzelpreis: "Bitte den Einzelpreis eingeben." },
  rechnungen: { rechnungsnummer: "Bitte die Rechnungsnummer eingeben.", auftrag: "Bitte den Auftrag auswählen.", kunde: "Bitte den Kunden auswählen.", rechnungsdatum: "Bitte das Rechnungsdatum wählen.", status: "Bitte den Rechnungsstatus wählen." },
  // </custom:messages>
};
