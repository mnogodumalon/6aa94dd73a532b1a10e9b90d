...
- `kundentyp` · lookup · Kundentyp · required! · options: privat | gewerbe
- `telefon` · tel · Telefon
- `email` · email · E-Mail
...
Input shapes: choice `kundentyp` (ChoiceGroup)

### `mitarbeiter` — Mitarbeiter (type `Mitarbeiter`, one record: `MitarbeiterEntry`)
Display fields: `vorname`, `nachname`
- `email` · email · E-Mail
- `vorname` · text · Vorname · required! · maxLength 4000
- `nachname` · text · Nachname · required! · maxLength 4000
- `rolle` · lookup · Rolle · required! · options: annahme | mechaniker | chef
- `stundensatz` · number · Stundensatz (€) · currency
- `status` · lookup · Status · required! · options: aktiv | krank | urlaub
Input shapes: choice `rolle` (ChoiceGroup); choice `status` (ChoiceGroup)

### `teilebestand` — Teilebestand (type `Teilebestand`, one record: `TeilebestandEntry`)
Display fields: `artikelnummer`
- `artikelnummer` · text · Artikelnummer · required! · maxLength 4000
- `bezeichnung` · text · Bezeichnung · required! · maxLength 4000
- `hersteller` · text · Hersteller · maxLength 4000
- `einkaufspreis` · number · Einkaufspreis (€) · currency
- `verkaufspreis` · number · Verkaufspreis (€) · currency
- `bestand` · number · Bestand (Stück)
- `mindestbestand` · number · Mindestbestand (Stück)
- `lagerplatz` · text · Lagerplatz · maxLength 4000
Input shapes: stock `bestand` (BudgetTracker)

### `fahrzeuge` — Fahrzeuge (type `Fahrzeuge`, one record: `FahrzeugeEntry`)
Display fields: `kennzeichen`
- `kennzeichen` · text · Kennzeichen · required! · maxLength 4000
- `marke` · text · Marke · required! · maxLength 4000
- `modell` · text · Modell · required! · maxLength 4000
- `erstzulassung` · date · Erstzulassung
- `kilometerstand` · number · Kilometerstand (km)
- `fahrgestellnummer` · text · Fahrgestellnummer · maxLength 4000
- `hu_faellig` · date · HU fällig
- `halter` · record · Halter (Kunde) · required! · → `kunden`

### `auftraege` — Aufträge (type `Auftraege`, one record: `AuftraegeEntry`)
Display fields: `auftragsnummer`
- `auftragsnummer` · text · Auftragsnummer · required! · maxLength 4000
- `fahrzeug` · record · Fahrzeug · required! · → `fahrzeuge`
- `annahmedatum` · date · Annahmedatum · required!
- `fertigstellungstermin` · date · Zugesagter Fertigstellungstermin
- `kundenwunsch` · textarea · Kundenwunsch
- `status` · lookup · Status · required! · options: angenommen | in_arbeit | fertig | abgerechnet | abgeholt
- `mechaniker` · record · Zuständiger Mechaniker · → `mitarbeiter`
- `kilometerstand_annahme` · number · Kilometerstand bei Annahme (km)
- `notizen` · textarea · Notizen
Input shapes: choice `status` (ChoiceGroup)

### `auftragspositionen` — Auftragspositionen (type `Auftragspositionen`, one record: `AuftragspositionenEntry`)
Display fields: `bezeichnung`
- `auftrag` · record · Auftrag · required! · → `auftraege`
- `positionstyp` · lookup · Positionstyp · required! · options: arbeit | teil
- `bezeichnung` · text · Bezeichnung · required! · maxLength 4000
- `menge` · number · Menge · required!
- `einzelpreis` · number · Einzelpreis (€) · required! · currency
- `mechaniker` · record · Mechaniker · → `mitarbeiter`
- `dauer_stunden` · number · Dauer (Stunden)
- `teil` · record · Verwendetes Teil · → `teilebestand`
Input shapes: choice `positionstyp` (ChoiceGroup)
...
- `faelligkeit` · date · Fälligkeit
- `nettobetrag` · number · Nettobetrag (€) · currency
- `mwst` · number · MwSt. (€) · currency
- `bruttobetrag` · number · Bruttobetrag (€) · currency
- `status` · lookup · Status · required! · options: offen | bezahlt | storniert
- `zahlungseingang` · date · Zahlungseingang
- `pdf` · file · Rechnungs-PDF · read-only
Input shapes: choice `status` (ChoiceGroup)
